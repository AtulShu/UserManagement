...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
	...
	@Query(value="select * from users u where  CAST(u.email_verification_status AS BOOLEAN) = true", 
			countQuery="select count(*) from users u where CAST(u.email_verification_status AS BOOLEAN) = true", 
			nativeQuery = true)
